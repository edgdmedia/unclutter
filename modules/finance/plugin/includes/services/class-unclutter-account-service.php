...
class Unclutter_Account_Service {
    ...
    public static function update_balance($profile_id, $id, $amount) {
        return Unclutter_Account_Model::update_balance($profile_id, $id, $amount);
    }
     ...
     */
    public static function account_belongs_to_profile($profile_id, $account_id) {
        $account = Unclutter_Account_Model::get_account($profile_id, $account_id);
     ...
     */
    public static function get_balance_history($profile_id, $account_id, $start_date, $end_date) {
        global $wpdb;
